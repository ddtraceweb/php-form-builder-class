...
class Form extends Base
{
    ...
    public $defaultUrlsCss = array();
    public $defaultUrlsJs = array();

    /**
     *  @param string $id name of form
     *  web directory need bootstrap, ckeditor, jquery-ui, jquery, tiny_mce in /assets/component/
     */
    public function __construct($id = "pfbc")
    {
        ...
        //web directory of ressources, need bootstrap, ckeditor, jquery-ui, jquery, tiny_mce
        $this->setResourcesPath("/assets/components");
    }
    ...
    protected function isAllowedUrl($url)
    {
        if (!empty($this->prevent)) {
            ...
            elseif (in_array("jquery", $this->prevent) && strpos($url, "/jquery.min.js") !== false)
                return false; elseif (in_array("jqueryui", $this->prevent) && strpos($url, "/jquery-ui/") !== false)
                return false;
        }
...
JS;
    ...
    /**
     * @param array $defaultUrlsJs
     */
    public function setDefaultUrlsJs(array $defaultUrlsJs)
    {
        $this->defaultUrlsJs = $defaultUrlsJs;
    }

    /**
     * @return array
     */
    public function getDefaultUrlsJs()
    {
        return $this->defaultUrlsJs;
    }

    /**
     * @param array $defaultUrlsCss
     */
    public function setDefaultUrlsCss(array $defaultUrlsCss)
    {
        $this->defaultUrlsCss = $defaultUrlsCss;
    }

    /**
     * @return array
     */
    public function getDefaultUrlsCss()
    {
        return $this->defaultUrlsCss;
    }
}
